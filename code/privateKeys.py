...
# function to get user's own private key
# param: userNumber: 1 or 2
def getUserPrivateKey(keyGenerator, userNumber=1):
    return keyGenerator.getD(userNumber - 1), keyGenerator.getN(userNumber - 1)